...
```bash
git clone https://github.com/takagolf1230-afk/https-github.com-.git
cd https-github.com-
...
python -m keiba_next backtest --db "C:\path\to\jv_data.db" --until 20260101 --model out/ranker.txt
